...
**Ваш собственный интеллектуальный терминал. 29 источников. Одна команда. Без облачных технологий. Нужно поменять**
...
> Сначала попробуйте демо-версию, чтобы понять, как всё работает, а затем при желании скачайте репозиторий и запустите Crucix у себя локально.
